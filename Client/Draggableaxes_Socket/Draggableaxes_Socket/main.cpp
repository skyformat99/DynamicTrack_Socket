...
int main(int argc, char **argv)
{
    ...
    container->setMinimumSize(1200, 1000);
	...
	//add socket transmission  yong added
	char path[100];
	sprintf(path, "%s", "G:\\ProjectFiles\\Socket\\Draggableaxes_Socket\\Draggableaxes_Socket\\data.txt");
	SocketClient win;
	win.CSocket_Init();
